    ...
    const portalOption = [
      {
        ...
        title: "Admin Portal",
        description:
          "Manage employees, department, payrolls and system configuration",
        icon: ShieldIcon,
      },
      {
        to: "/login/employee",
        ...
        description:
          "View your profile, track attendace, request leave and access payslip",
        icon: UserIcon,
      },
    ];
  return (
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-6 sm:p-12 lg:p-16 relative overflow-y-auto min-h-screen">
        <div className="w-full max-w-md animate-fade-in relative z-10">
            ...
            {portalOption.map((portal) => (
              ...
              >
                <div className="">
                  ...
                  <ArrowRightIcon className="group-hover:text-indigo-600 w-4 h-4 text-slate-400 group-hover:translate-x-1 transition-all duration-300" />
                </div>
              </Link>
            ))}
          </div>
          ...
          <div className="mt-12 text-center md:text-left text-sm text-slate-400">
            <p>© {new Date().getFullYear()}CodeHunter LLc. All right reserved</p>
          </div>
        </div>
      </div>
    </div>
