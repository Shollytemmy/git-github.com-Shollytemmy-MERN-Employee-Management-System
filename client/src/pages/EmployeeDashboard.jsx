      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-3 mb-8">
        {cards.map((card, index) => (
          ...
          >
            ...
            <card.icon className="size-10 p-2.5 rounded-lg bg-slate-100 text-slate-600 group-hover:bg-indigo-50 group-hover:text-indigo-600 transition-all duration-300" />
          </div>
        ))}
        <div className="flex flex-col sm:flex-row gap-3">
          <Link
            to="/attendance"
            className="btn-primary text-center inline-flex justify-center items-center gap-2"
          >
